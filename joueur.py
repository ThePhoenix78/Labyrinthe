...
def ajouterTresor(joueur,tresor):
    ...
    for i in range(len(listeJoueurs)):
        if joueur == listeJoueurs[i][0]:
            listeJoueurs[i][1].append(tresor)
